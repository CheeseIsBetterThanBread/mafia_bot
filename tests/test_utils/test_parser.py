...
def test_types(template):
    ...
    input_string = template.format(integer=42, boolean=False, string="string", point=3.14)
    values = parser.parse(input_string)
    assert values
    ...
    input_string = template.format(integer=61, boolean='yes', string="string", point=2.78)
    values = parser.parse(input_string)
    assert values
    ...
    input_string = new_template.format(integer=17, boolean='1', string="string", point=2.78)
    values = parser.parse(input_string)
    assert values
...
def test_invalid_input(template):
    ...
    input_string = new_template.format(integer=73, boolean=False, string="string", point=1.0, bug="oh")
    values = parser.parse(input_string)
